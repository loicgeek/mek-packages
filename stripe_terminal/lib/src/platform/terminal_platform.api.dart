...
AmountDetails _$deserializeAmountDetails(List<Object?> serialized) => AmountDetails(
    ...
    surchargeDetails: serialized[1] != null
        ? _$deserializeSurchargeDetails(serialized[1] as List)
        : null);
SurchargeDetails _$deserializeSurchargeDetails(List<Object?> serialized) => SurchargeDetails(
    surchargeAmount: serialized[0] as int,
    status: SurchargeStatus.values[serialized[1] as int]);
...
CardPresentDetails _$deserializeCardPresentDetails(List<Object?> serialized) => CardPresentDetails(
    ...
    captureBefore: serialized[12] != null
        ? DateTime.fromMillisecondsSinceEpoch(serialized[12] as int)
        : null,
    reauthorizeBefore: serialized[13] != null
        ? DateTime.fromMillisecondsSinceEpoch(serialized[13] as int)
        : null);
